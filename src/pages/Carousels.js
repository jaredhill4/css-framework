    ...
    <Section>
      ...
      <Description>
        <p>
          ...
          so all the same settings, events and methods are available for you to
          use.
        </p>
        <p>
          One caveat to this is how we handle the Slick methods. For these, we
          provide a custom API, to make hooking into them simpler and consistent
          with our other JavaScript components.
        </p>
        <p>
      ...
      <Description>
        To create a carousel, you will first need to create the markup, which is
        simply a series of html elements (typically <code>div</code>s) nested
        inside a parent element (also typically a <code>div</code>) with a
        unique selector (like an id, class name or data attribute). In this
        example, we will use a data attribute selector, with the value
        "sample-carousel."
      </Description>
    ...
    <div class="carousel__slide">
      ...
      <Description>
        <p>
          ...
          JavaScript component function (with your unique selector as the first
          argument) and assign it to a variable, like so:
        </p>
      </Description>
...
const sampleCarousel = carousel('[data-carousel="sample-carousel"]', sampleCarouselSettings);`}
      ...
      <Description>
        <p>
          ...
          <code>on()</code> method, along with a callback function as the second
          argument, like so:
        </p>
      </Description>
      <Code language="javascript" collapsible={false}>
...
sampleCarousel.on('afterChange', (event, slick, currentSlide) => {
  // do something after the slide changes...
      ...
      <Description>
        <p>
          You can also hook into the various Slick methods, using our custom API
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              removeBefore is set to false, remove the slide following index, or
              the last slide if no index is set.
            </td>
            <td>
