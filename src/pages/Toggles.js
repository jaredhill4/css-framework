...
export default () => {
  ...
  return (
    <Section>
      ...
      <Description>
        <p>
          Use the <strong>toggle</strong> component to toggle the visibility of
          sections of content.
        </p>
      </Description>
      ...
      <Description>
        ...
        <p>
          ...
          <code>data-toggle-target</code> attribute with a unique identifier as
          its value. (It should also have the class <code>.toggle__target</code>
          , but if you forget to add the class, it will be added dynamically on
          page load.)
        </p>
        <p>
        ...
        <p>
          <em>
            Note: It is important not to place any padding, margin or border on
            the target element, as this could cause an undesireable jumpy effect
            as the element is toggled. Therefore, it is recommended to place any
            necessary block styling on an element nested within the target
            element.
          </em>
        </p>
      </Description>
...
<div class="toggle__target" data-toggle-target="simple-toggle-element">
    ...
      ...
      <Description>
        ...
        <p>
          You can achieve this by grouping (nesting) multiple <em>switches</em>{' '}
          and <em>targets</em> inside a parent element with the{' '}
          <code>data-toggle-group</code> attribute. The{' '}
    ...
    <dd class="toggle__target" data-toggle-target="styled-accordion-item-3">
      ...
      <Description>
        <p>
          Similar to accordions, you can also create <strong>tabs</strong> using
          toggle groups.
        </p>
        <p>
        ...
        <p>
          Finally, add <code>data-toggle-target-transition="fade"</code> to each
          of the <code>data-toggle-target</code> elements to change the
          transition to "fade."
        </p>
      </Description>
      <Example>
          ...
          >
            <nav className="tabs__nav">
              <ul>
                ...
                <li>
                  <button data-toggle-switch="tab-2" data-toggle-parent="tabs">
                    Tab 2
                  </button>
                </li>
                <li>
                  <button data-toggle-switch="tab-3" data-toggle-parent="tabs">
                    Tab 3
                  </button>
                </li>
              </ul>
    ...
    <div class="tabs__content">
      ...
      <Description>
        <p>
          ...
          toggle <em>target</em> elements as the selector.
        </p>
        <p>
          <em>
            Note: For the group methods to work properly, the{' '}
            <code>data-toggle-group-allow-multiple</code> attribute must be set
            to <code>true</code> on parent element.
          </em>
        </p>
      </Description>
