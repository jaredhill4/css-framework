...
export default () => (
  <Section>
    ...
    <Description>
      Form fields can be highlighted with validation state classes with{' '}
      <code>.form__field--*</code>. Available modifiers are <code>success</code>,{' '}
    ...
    <Example>
      <ExampleView>
        <div className="form__field form__field--success">
          ...
          <input type="text" className="form__input" placeholder="Success" />
        ...
        <div className="form__field form__field--error">
          ...
          <input type="text" className="form__input" placeholder="Info" />
        ...
        <div className="form__field form__field--warning">
          ...
          <input type="text" className="form__input" placeholder="Warning" />
